...
/**
 * A library that handling Hangul characters in syllable units for romanization.
 * Based on the National Korean Language Romanization standard.
 *
 * Original implementation: korean-romanizer by crizin (https://github.com/crizin/korean-romanizer)
 * Copyright (c) 2014-2018 by crizin
 * Licensed under the MIT License
 */
public class RomanizedCharacter implements Serializable, Comparable<RomanizedCharacter> {
	/**
	...
	/**
	 * The consonant used as the initial syllable of Hangul, which is called "Chosung".
	 */
	public enum Chosung {
		ㄱ("g") {
			protected String getComplexPronunciation(RomanizedCharacter prevCharacter, RomanizedCharacter currentCharacter, ConsonantAssimilation consonantAssimilation, Type type) {
		...
		public String getPronunciation(RomanizedCharacter prevCharacter, RomanizedCharacter currentCharacter, ConsonantAssimilation consonantAssimilation, Type type) {
	...
	public enum Jungsung {
		...
		public String getPronunciation(RomanizedCharacter prevCharacter, RomanizedCharacter currentCharacter) {
	...
	public enum Jongsung {
		NONE(""),
		ㄱ("k") {
			protected String getComplexPronunciation(RomanizedCharacter nextCharacter, ConsonantAssimilation consonantAssimilation, Type type) {
		...
		public String getPronunciation(RomanizedCharacter nextCharacter, ConsonantAssimilation consonantAssimilation, Type type) {
	 ...
	 */
	public RomanizedCharacter(char koreanCharacter) {
	 ...
	 */
	public RomanizedCharacter(Chosung chosung, Jungsung jungsung, Jongsung jongsung) {
	 ...
	 * @return the romanized string of the character this object has.
	 */
	public String getRomanizedString(RomanizedCharacter prevCharacter, RomanizedCharacter nextCharacter, ConsonantAssimilation consonantAssimilation, Type type) {
	 ...
	 */
	@Override
	public int compareTo(RomanizedCharacter other) {
	...
	public boolean equals(Object other) {
		...
		return character == ((RomanizedCharacter) other).character;
	}
